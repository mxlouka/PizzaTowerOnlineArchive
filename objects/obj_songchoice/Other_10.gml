...
switch sel[0]
{
	case 0: // PIZZA TOWER
		selarray = [
			...
			[mu_pizzatime, "It's Pizza Time!", "Mr. Sauceman"],
			[mu_chase, "The Death That\nI Deservioli", "Mr. Sauceman"],
			[mu_noiseescape, "Distasteful Anchovi", "Frostix"],
			[mu_noiseescape_OLD, "Pesto Anchovi", "Frostix"],
			[mu_miniboss, "Pimpin' Hot Stuff", "Mr. Sauceman"],
			...
			[mu_war, "Thousand March", "Mr. Sauceman"],
			[mu_factory, "Pizza Engineer", "Mr. Sauceman"],
			[mu_factory2, "Peppino's Sauce Machine", "Mr. Sauceman"],
			...
			[mu_desertsecret, "Desert Secret", "Frostix"],
	...
	case 1:
		selarray = [
			...
			[mu_pizzatime_PP, "It's Piss Time!", "Mr. Sauceman, The Living Tombstone, loypoll"],
			[mu_hube, "Saturdays", "loypoll"],
			[mu_hubarcade, "ARCADE", "loypoll"],
			[mu_hubarcade_alt, "ARCADE (Muted)", "loypoll"],
	...
	case 2:
		selarray = [
			...
			[mu_pizzatime_pc, "It's Pizza Time!", "loypoll"],
			[mu_chase_pc, "The Death That\nI Deservioli", "loypoll"],
			[mu_noiseescape_pc, "Distasteful Anchovi", "loypoll"],
			[mu_noiseescape_OLD_pc, "Pesto Anchovi", "loypoll"],
			[mu_miniboss_pc, "Pimpin' Hot Stuff", "loypoll"],
			...
			[mu_war_pc, "Thousand March", "loypoll"],
			[mu_factory_pc, "Pizza Engineer", "loypoll"],
			[mu_factory2_pc, "Peppino's Sauce Machine", "loypoll"],
			...
			[mu_desertsecret_pc, "Desert Secret", "loypoll"],
			...
			[mu_pizzatime_PP_pc, "It's Piss Time!", "loypoll"],
			[mu_hube_pc, "Saturdays", "loypoll"],
			[mu_hubarcade_pc, "ARCADE", "loypoll"],
			[mu_hubarcade_alt_pc, "ARCADE (Muted)", "loypoll"],
			...
			[mu_antonlevel_pc, "Ballbuster Blues", "Tony Grayson"],
			[mu_antonsecret_pc, "Bonus Blitz", "Tony Grayson"],
			[mu_antonpunchball_pc, "Punch Bowl", "Tony Grayson"],
			[mu_antonescape_pc, "VS! Sewer Slam","Tony Grayson"],
		...
		{
			array_push(selarray, 
				[mu_pizzyescape_pc, "Glucose Getaway", "loypoll"],
	...
	case 3:
		selarray = [
			[mu_pizzyescape, "Glucose Getaway", "RodMod"],
