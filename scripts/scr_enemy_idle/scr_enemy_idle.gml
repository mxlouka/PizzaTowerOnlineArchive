function scr_enemy_idle() 
{
	...
	if scaredbuffer > 0
	{
		...
		if sugaryenemy && grounded && global.gameplay == 0
			vsp = -5;
	}
	
	if ((variable_instance_exists(id, "turnspr") && sprite_index == turnspr) or sprite_index == spr_indiancheese_turn or sprite_index == spr_tank_spawnenemy)
