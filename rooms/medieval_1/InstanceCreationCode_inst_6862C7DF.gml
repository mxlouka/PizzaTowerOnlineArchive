...
if global.snickchallenge
{
	...
	{
		prompt_array[0] = tv_create_prompt("PTV seems to have catched on camera a glimpse of flying purple porcupine following a fat italian man in this area.", false, spr_tv_idleanim1, 3);
